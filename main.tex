...
$$H(jw)\simeq{-{\alpha_0\over\alpha_1}\left[1-{\alpha_3w^2\over\alpha_1\alpha_2}T^2\right]\over1-{w^2T^2\over\alpha_1\alpha_2}+{jw\alpha_4T\over\alpha_1\alpha_2}}={-H_0(1-{w^2\over w_z^2}\over 1-{w^2\overw_0^2}+{jw\over  w_0Q}}\quad\text{$w_z>w_0$\\Low pass notch\\$w_z<w_0$\\high pass notch}$$
...
\section{DC & AC Parameters}\index{DC & AC Parameters!Continuous to Sampled Data Systems}
